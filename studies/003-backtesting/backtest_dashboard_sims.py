import argparse
from generate_study_backtesting import run_and_save_study_array
...
folder = f"studies/003-backtesting/start_{args.start_type}_duration_{args.duration_type}_x{num_start_times}/"
