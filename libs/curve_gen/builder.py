...
from libs.curve_gen.training.builder import TrainingConfigBuilder, TrainingConfig
from libs.curve_gen.kelly_fit.builder import FitConfigBuilder, FitConfig
from libs.curve_gen.constraints.builder import (
    ConstraintsConfigBuilder,
    ConstraintsConfig,
)
...
class GeneratorConfigBuilder:
    ...
    def build_config(self):
        ...
        return GeneratorConfig(
            self.train_builder.build_config(),
            self.fit_builder.build_config(),
