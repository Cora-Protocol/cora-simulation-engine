...
from libs.curve_gen.payoff.builder import PayoffConfig, PayoffConfigBuilder
from libs.curve_gen.payoff.black_scholes import check_div_zero
...
class Payoff:
    ...
    def get_payoff_odds(self, premium=0.0):
        ...
        odds = (self.config.total_payoff + premium) / self.get_position_max_loss(
            premium
        )
        return odds
